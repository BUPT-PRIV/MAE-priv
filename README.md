...
|      100       |  Cls-token   |   |  34.89%  |  18.44%  | [pretrain](cfgs/pretrain/baseline_small/ViT-S_100E_Norm_CLS-Token.yaml) [finetune](cfgs/finetune/ViT-S_50E_CLS-Token.yaml) | pretrain finetune | pretrain finetune |
